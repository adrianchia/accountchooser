...
var MSG_CONTAINER_ABOUT_DEPLOY_BUTTON = function(beginLink, endLink) {
  return beginLink + ("M\u00e1s informaci\u00f3n sobre c\u00f3mo implementar un selector de cuentas" + endLink)
};
...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"A\u00f1adir cuenta", titleMultiple:"A\u00f1adir cuentas", confirm:"Recordar esta cuenta", confirmMultiple:"Recordar estas cuentas", cancel:"Omitir este paso"}, updateAccountPage:{title:"Actualizar cuenta", confirm:"Actualizar cuenta", cancel:"Cancelar"}, selectAccountPage:{title:"Iniciar sesi\u00f3n en", seeMoreAccounts:"Ver m\u00e1s", notUsable:"No se puede utilizar en este sitio.", addAccount:"A\u00f1adir cuenta"}, 
manageAccountPage:{title:"Administrar cuentas", deleteReminder:"La cuenta se ha eliminado. Es posible que en algunos sitios web a\u00fan puedas iniciar sesi\u00f3n con ella o que esos sitios todav\u00eda recuerden que has utilizado esa cuenta."}, manageContainer:{header:"Tus cuentas", description:"Haz clic en una cuenta para eliminarla del Selector de cuentas."}, selectContainer:{header:"Seleccionar una cuenta en la que iniciar sesi\u00f3n"}, storeContainer:{header:"A\u00f1adir tu cuenta a este dispositivo", 
headerMultiple:"A\u00f1adir tus cuentas a este dispositivo", description:"Si est\u00e1s cansado de iniciar sesi\u00f3n tan a menudo, a\u00f1ade tu cuenta aqu\u00ed. Es posible que las aplicaciones nuevas, como un sitio web de compras, te permitan registrarte con solo hacer clic en la cuenta o introducir la contrase\u00f1a.", descriptionMultiple:"Si est\u00e1s cansado de iniciar sesi\u00f3n tan a menudo, a\u00f1ade tus cuentas aqu\u00ed. Es posible que las aplicaciones nuevas, como un sitio web de compras, te permitan registrarte con solo hacer clic en la cuenta o introducir la contrase\u00f1a.", 
benefits:["Una vez que hayas a\u00f1adido una cuenta a este dispositivo, no tendr\u00e1s que escribir tu direcci\u00f3n de correo electr\u00f3nico cada vez que una p\u00e1gina te solicite que inicies sesi\u00f3n. Solo deber\u00e1s seleccionar la cuenta correcta en una lista.", "Algunas p\u00e1ginas te pedir\u00e1n la contrase\u00f1a, pero otras iniciar\u00e1n tu sesi\u00f3n autom\u00e1ticamente cuando hagas clic en el nombre de la cuenta."]}, updateContainer:{header:"Actualizar los datos de la cuenta", 
description:"Confirma los detalles que se mostrar\u00e1n en el selector de cuentas."}, aboutContainer:{title:"Acerca del selector de cuentas", header:"Acerca del selector de cuentas", sec1Par1:"Los sitios web van a sustituir los cuadros tradicionales de inicio de sesi\u00f3n por un selector de cuentas que permita que los sitios sean m\u00e1s seguros y sencillos de utilizar. Cuando intentes iniciar sesi\u00f3n en un sitio, observar\u00e1s una p\u00e1gina similar a esta con la lista de cuentas que utilizas con mayor frecuencia en este ordenador.", 
subHeader1:"Usuarios: c\u00f3mo funciona", sec2Par1:"Una vez que hayas a\u00f1adido una cuenta a este dispositivo, no tendr\u00e1s que escribir tu direcci\u00f3n de correo electr\u00f3nico cada vez que una p\u00e1gina te solicite que inicies sesi\u00f3n. Solo deber\u00e1s seleccionar la cuenta correcta en una lista.", sec2Par2:"Algunas p\u00e1ginas te pedir\u00e1n la contrase\u00f1a, pero otras iniciar\u00e1n tu sesi\u00f3n autom\u00e1ticamente cuando hagas clic en el nombre de la cuenta.", subHeader2:"Propietarios de sitios web: m\u00e1s informaci\u00f3n sobre c\u00f3mo actualizar el sitio", 
sec3Par1:"A continuaci\u00f3n, se indican las diferentes ventajas de actualizar el sitio para utilizar un selector de cuentas:", sec3Par1List1:"Aumenta los porcentajes de inicios de sesi\u00f3n y de registros en el sitio.", sec3Par1List2:"Hace m\u00e1s f\u00e1cil que el sitio web sea compatible con proveedores de identidad en el futuro.", sec3Par1List3:"Solo requiere algunos cambios muy peque\u00f1os en el sitio.", deployButton:MSG_CONTAINER_ABOUT_DEPLOY_BUTTON('<a href="http://accountchooser.net/owners">', 
...
footerContainer:{copyright:"Copyright 2012 OpenID Foundation.", learnMore:"Acerca del selector de cuentas", learnMoreLink:"/learnmore.html"}});
