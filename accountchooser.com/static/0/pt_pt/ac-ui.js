...
var MSG_CONTAINER_ABOUT_DEPLOY_BUTTON = function(beginLink, endLink) {
  return beginLink + ("Saiba como pode implementar um seletor de contas" + endLink)
};
...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"Adicionar conta", titleMultiple:"Adicionar contas", confirm:"Memorizar esta conta", confirmMultiple:"Memorizar estas contas", cancel:"Ignorar isto"}, updateAccountPage:{title:"Atualizar conta", confirm:"Atualizar conta", cancel:"Cancelar"}, selectAccountPage:{title:"Iniciar sess\u00e3o em", seeMoreAccounts:"Ver mais", notUsable:"N\u00e3o utiliz\u00e1vel neste Website", addAccount:"Adicionar conta"}, 
manageAccountPage:{title:"Gerir contas", deleteReminder:"Conta removida. Em alguns Websites, ainda pode estar registado nesta conta ou esses Websites ainda se podem lembrar que utilizou esta conta."}, manageContainer:{header:"As Suas Contas", description:"Clique em qualquer conta para a eliminar do Selecionador de Contas"}, selectContainer:{header:"Selecione uma conta para iniciar sess\u00e3o"}, storeContainer:{header:"Adicionar a sua conta a este dispositivo", headerMultiple:"Adicionar as suas contas a este dispositivo", 
description:"Est\u00e1 cansado de iniciar sess\u00e3o tantas vezes? Adicione a sua conta aqui. As novas aplica\u00e7\u00f5es (como um Website de compras) poder\u00e3o at\u00e9 permitir a inscri\u00e7\u00e3o atrav\u00e9s de um clique na conta ou da introdu\u00e7\u00e3o da palavra-passe.", descriptionMultiple:"Est\u00e1 cansado de iniciar sess\u00e3o tantas vezes? Adicione a sua conta aqui. As novas aplica\u00e7\u00f5es (como um Website de compras) poder\u00e3o at\u00e9 permitir a inscri\u00e7\u00e3o atrav\u00e9s de um clique na conta ou da introdu\u00e7\u00e3o da palavra-passe.", 
benefits:["Assim que adicionar uma conta a este dispositivo, n\u00e3o ter\u00e1 de introduzir o seu endere\u00e7o de email sempre que uma p\u00e1gina solicitar o in\u00edcio de sess\u00e3o. Basta selecionar a conta correta a partir de uma lista.", "Algumas p\u00e1ginas ir\u00e3o solicitar a sua palavra-passe, enquanto outras iniciar\u00e3o sess\u00e3o automaticamente depois de clicar no nome da conta."]}, updateContainer:{header:"Atualizar os detalhes da sua conta", description:"Confirme os detalhes que ser\u00e3o apresentados no seu Selecionador de Contas."}, 
aboutContainer:{title:"Acerca do Selecionador de Contas", header:"Acerca do Selecionador de Contas", sec1Par1:"Os Websites est\u00e3o a substituir as caixas de entrada em sess\u00e3o tradicionais por um selecionador de contas para torn\u00e1-los mais seguros e mais f\u00e1ceis de utilizar (explore um site de exemplo). Quando tenta iniciar sess\u00e3o num site, ver\u00e1 uma p\u00e1gina como esta com a lista das contas que utiliza mais frequentemente neste computador:", subHeader1:"Utilizadores: Como funciona", 
sec2Par1:"Assim que adicionar uma conta a este dispositivo, n\u00e3o ter\u00e1 de introduzir o seu endere\u00e7o de email sempre que uma p\u00e1gina solicitar o in\u00edcio de sess\u00e3o. Basta selecionar a conta correta a partir de uma lista.", sec2Par2:"Algumas p\u00e1ginas ir\u00e3o solicitar a sua palavra-passe, enquanto outras iniciar\u00e3o sess\u00e3o automaticamente depois de clicar no nome da conta.", subHeader2:"Propriet\u00e1rios de Websites: saiba como atualizar o seu Website", sec3Par1:"Existem v\u00e1rias vantagens em atualizar o Website para utilizar um Selecionador de Contas:", 
sec3Par1List1:"Aumente as taxas de in\u00edcio de sess\u00e3o e inscri\u00e7\u00e3o no seu Website", sec3Par1List2:"Faz com que seja mais f\u00e1cil para o seu Website suportar fornecedores de identidade no futuro", sec3Par1List3:"Precisa apenas de algumas altera\u00e7\u00f5es muito pequenas no Website", deployButton:MSG_CONTAINER_ABOUT_DEPLOY_BUTTON('<a href="http://accountchooser.net/owners">', "</a>"), accountManHome:{email:"john.garcia@gmail.com", displayName:"John Garcia", photoUrl:window.accountchooser.images.manHome}, 
accountManWork:{email:"jgarcia@summitmedgroup.com", displayName:"John Garcia", photoUrl:window.accountchooser.images.manWork}, accountWomanHome:{email:"sara_corlett@yahoo.com", displayName:"Sara Corlett", photoUrl:window.accountchooser.images.womanHome}, accountWomanWork:{email:"corlett@alertblue.com", displayName:"Mrs. Corlett", photoUrl:window.accountchooser.images.womanWork}}, footerContainer:{copyright:"Copyright 2012 OpenID Foundation.", learnMore:"Acerca do Selecionador de Contas", learnMoreLink:"/learnmore.html"}});
