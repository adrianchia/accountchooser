...
var MSG_CONTAINER_ABOUT_DEPLOY_BUTTON = function(beginLink, endLink) {
  return beginLink + ("Matutunan kung paano ka makakapagtalaga ng tagapili ng account" + endLink)
};
...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"Magdagdag ng account", titleMultiple:"Magdagdag ng mga account", confirm:"Tandaan ang account na ito", confirmMultiple:"Tandaan ang mga account na ito", cancel:"Laktawan ito"}, updateAccountPage:{title:"I-update ang account", confirm:"I-update ang account", cancel:"Kanselahin"}, selectAccountPage:{title:"Mag-sign in sa", seeMoreAccounts:"Tumingin ng higit pa", notUsable:"Hindi nagagamit sa site na ito", 
addAccount:"Magdagdag ng account"}, manageAccountPage:{title:"Pamahalaan ang mga account", deleteReminder:"Inalis ang account. Maaaring naka-log in ka pa rin sa account na ito sa ilang website, o maaaring natatandaan pa rin ng mga site na iyon na ginamit mo ang account na ito."}, manageContainer:{header:"Iyong Mga Account", description:"Mag-click sa anumang account upang tanggalin ito sa Tagapili ng Account"}, selectContainer:{header:"Pumili ng account kung saan magsa-sign in"}, storeContainer:{header:"Idagdag ang iyong account sa device na ito", 
headerMultiple:"Idagdag ang iyong mga account sa device na ito", description:"Sawa ka na ba sa pagsa-sign in nang madalas? Idagdag dito ang iyong account. Maaari ka ring bigyang-daan ng bagong apps (tulad ng isang website sa pamimili) na mag-sign up sa pamamagitan lang ng pag-click sa account o paglalagay ng password nito.", descriptionMultiple:"Sawa ka na ba sa pagsa-sign in nang madalas? Idagdag dito ang iyong mga account. Maaari ka ring bigyang-daan ng bagong apps (tulad ng isang website sa pamimili) na mag-sign up sa pamamagitan lang ng pag-click sa account o paglalagay ng password nito.", 
benefits:["Sa sandaling magdagdag ka ng account sa device na ito, hindi mo na kakailanganing i-type ang iyong email address sa tuwing hihingin sa iyo ng isang pahina na mag-sign in. Piliin lang ang tamang account mula sa isang listahan.", "Hihingin ng ilang pahina ang iyong password, ngunit awtomatiko kang isa-sign ng iba pagkatapos mong i-click ang pangalan ng account."]}, updateContainer:{header:"I-update ang mga detalye ng iyong account", description:"Kumpirmahin ang mga detalyeng ipapakita sa iyong Tagapili ng Account."}, 
aboutContainer:{title:"Tungkol sa Tagapili ng Account", header:"Tungkol sa Tagapili ng Account", sec1Par1:"Pinapalitan ng mga website ang mga tradisyonal na box para sa pag-log in ng isang tagapili ng account upang gawing mas secure at mas madaling gamitin ang mga site na iyon. Kapag sinubukan mong mag-sign in sa ganoong site, makakakita ka ng pahina gaya nito na may listahan ng mga account na pinakamadalas mong ginagamit sa computer na ito.", subHeader1:"Mga User: Paano ito gumagana", sec2Par1:"Sa sandaling magdagdag ka ng account sa device na ito, hindi mo na kakailanganing i-type ang iyong email address sa tuwing hihingin sa iyo ng isang pahina na mag-sign in. Piliin lang ang tamang account mula sa isang listahan.", 
sec2Par2:"Hihingin ng ilang pahina ang iyong password, ngunit awtomatiko kang isa-sign ng iba pagkatapos mong i-click ang pangalan ng account.", subHeader2:"Mga May-ari ng Website: Matutunan kung paano i-upgrade ang iyong site", sec3Par1:"May ilang kalamangan sa pag-upgrade ng iyong site upang makagamit ng Tagapili ng Account:", sec3Par1List1:"Pataasin ang mga rate ng pag-signin at pag-signup sa iyong site", sec3Par1List2:"Pinapadali para sa iyong site na suportahan ang mga provider ng pagkakakilanlan sa hinaharap", 
sec3Par1List3:"Nangangailangan lang ito ng ilang napakaliit na pagbabago sa iyong site", deployButton:MSG_CONTAINER_ABOUT_DEPLOY_BUTTON('<a href="http://accountchooser.net/owners">', "</a>"), accountManHome:{email:"john.garcia@gmail.com", displayName:"John Garcia", photoUrl:window.accountchooser.images.manHome}, accountManWork:{email:"jgarcia@summitmedgroup.com", displayName:"John Garcia", photoUrl:window.accountchooser.images.manWork}, accountWomanHome:{email:"sara_corlett@yahoo.com", displayName:"Sara Corlett", 
photoUrl:window.accountchooser.images.womanHome}, accountWomanWork:{email:"corlett@alertblue.com", displayName:"Mrs. Corlett", photoUrl:window.accountchooser.images.womanWork}}, footerContainer:{copyright:"Copyright 2012 OpenID Foundation.", learnMore:"Tungkol sa Tagapili ng Account", learnMoreLink:"/learnmore.html"}});
