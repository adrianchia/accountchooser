...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"Add account", titleMultiple:"Add accounts", confirm:"Remember this account", confirmMultiple:"Remember these accounts", cancel:"Skip this"}, updateAccountPage:{title:"Update account", confirm:"Update account", cancel:"Cancel"}, selectAccountPage:{title:"Sign in to", seeMoreAccounts:"See more", notUsable:"Not usable with this site", addAccount:"Add account"}, manageAccountPage:{title:"Manage accounts", 
deleteReminder:"Account removed. On some websites you may still be logged into this account, or those sites may still remember you used this account."}, manageContainer:{header:"Your Accounts", description:"Click on any account to delete it from Account Chooser"}, selectContainer:{header:"Select an account to sign in to"}, storeContainer:{header:"Add your account to this device", headerMultiple:"Add your accounts to this device", description:"Tired of signing in so often? Add your account here. New apps (like a shopping website) may even let you sign up just by clicking the account or entering its password.", 
descriptionMultiple:"Tired of signing in so often? Add your accounts here. New apps (like a shopping website) may even let you sign up just by clicking the account or entering its password.", benefits:["Once you add an account to this device, you won't have to type your email address whenever a page asks you to sign in. Just select the right account from a list.", "Some pages will ask for your password, but others will sign you in automatically after you click the account name."]}, updateContainer:{header:"Update your account details", 
description:"Confirm the details that will be displayed in your Account Chooser."}, aboutContainer:{title:"About Account Chooser", header:"About Account Chooser", sec1Par1:"Websites are replacing traditional login boxes with an account chooser to make those sites more secure and easier to use. When you try to sign in to such a site, you will see a page like this one with the list of accounts you most frequently use on this computer.", subHeader1:"Users: How it works", sec2Par1:"Once you add an account to this device, you won't have to type your email address whenever a page asks you to sign in. Just select the right account from a list.", 
sec2Par2:"Some pages will ask for your password, but others will sign you in automatically after you click the account name.", subHeader2:"Website Owners: Learn how to upgrade your site", sec3Par1:"There are several advantages to upgrading your site to use an Account Chooser:", sec3Par1List1:"Increase signin and signup rates on your site", sec3Par1List2:"Makes it easier for your site to support identity providers in the future", sec3Par1List3:"It only requires a few very small changes to your site", 
...
displayName:"Mrs. Corlett", photoUrl:window.accountchooser.images.womanWork}}, footerContainer:{copyright:"Copyright 2012 OpenID Foundation.", learnMore:"About Account Chooser", learnMoreLink:"/learnmore.html"}});
