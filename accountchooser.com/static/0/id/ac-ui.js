...
var MSG_CONTAINER_ABOUT_DEPLOY_BUTTON = function(beginLink, endLink) {
  return beginLink + ("Pelajari cara untuk dapat menggunakan pemilih akun" + endLink)
};
...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"Tambahkan akun", titleMultiple:"Menambahkan akun", confirm:"Ingat akun ini", confirmMultiple:"Ingat akun ini", cancel:"Lewati ini"}, updateAccountPage:{title:"Memperbarui akun", confirm:"Perbarui akun", cancel:"Batal"}, selectAccountPage:{title:"Masuk ke", seeMoreAccounts:"Lihat selengkapnya", notUsable:"Tidak dapat digunakan dengan situs ini", addAccount:"Tambahkan akun"}, manageAccountPage:{title:"Mengelola akun", 
deleteReminder:"Akun dihapus. Pada beberapa situs web, Anda mungkin masih masuk ke dalam akun ini, atau situs tersebut mungkin masih mengingat bahwa Anda menggunakan akun ini."}, manageContainer:{header:"Akun Anda", description:"Klik akun mana saja untuk menghapusnya dari Pemilih Akun"}, selectContainer:{header:"Pilih akun untuk dimasuki"}, storeContainer:{header:"Tambahkan akun Anda ke perangkat ini", headerMultiple:"Tambahkan akun Anda ke perangkat ini", description:"Lelah karena keseringan masuk? Tambahkan akun Anda di sini. Aplikasi baru (misalnya situs web berbelanja) bahkan dapat memungkinkan Anda mendaftar cukup dengan mengeklik akun atau memasukkan sandinya.", 
descriptionMultiple:"Lelah karena keseringan masuk? Tambahkan akun Anda di sini. Aplikasi baru (misalnya situs web berbelanja) bahkan dapat memungkinkan Anda mendaftar cukup dengan mengeklik akun atau memasukkan sandinya.", benefits:["Setelah menambahkan akun ke perangkat ini, Anda tidak perlu mengetik alamat email setiap kali laman meminta Anda untuk masuk. Cukup pilih akun yang benar dari daftar.", "Beberapa laman akan meminta sandi Anda, tetapi laman yang lain akan membuat Anda masuk secara otomatis setelah Anda mengeklik nama akun."]}, 
updateContainer:{header:"Perbarui detail akun Anda", description:"Konfirmasi detail yang akan ditampilkan di Pemilih Akun Anda."}, aboutContainer:{title:"Tentang Pemilih Akun", header:"Tentang Pemilih Akun", sec1Par1:"Situs web mengganti kotak masuk tradisional dengan pemilih akun untuk membuat situs tersebut lebih aman dan lebih mudah digunakan. Saat mencoba masuk ke situs tersebut, Anda akan melihat laman seperti yang satu ini dengan daftar akun yang paling sering Anda gunakan di komputer ini.", 
subHeader1:"Pengguna: Cara kerjanya", sec2Par1:"Setelah menambahkan akun ke perangkat ini, Anda tidak perlu mengetik alamat email setiap kali laman meminta Anda untuk masuk. Cukup pilih akun yang benar dari daftar.", sec2Par2:"Beberapa laman akan meminta sandi Anda, tetapi laman yang lain akan membuat Anda masuk secara otomatis setelah Anda mengeklik nama akun.", subHeader2:"Pemilik Situs Web: Pelajari cara meningkatkan versi situs Anda", sec3Par1:"Ada beberapa keuntungan dalam meningkatkan versi situs Anda untuk menggunakan Pemilih Akun:", 
sec3Par1List1:"Meningkatkan tingkat pendaftaran dan masuk ke situs Anda", sec3Par1List2:"Memudahkan situs Anda mendukung penyedia identitas di masa mendatang", sec3Par1List3:"Hanya membutuhkan sedikit perubahan kecil pada situs Anda", deployButton:MSG_CONTAINER_ABOUT_DEPLOY_BUTTON('<a href="http://accountchooser.net/owners">', "</a>"), accountManHome:{email:"john.garcia@gmail.com", displayName:"John Garcia", photoUrl:window.accountchooser.images.manHome}, accountManWork:{email:"jgarcia@summitmedgroup.com", 
displayName:"John Garcia", photoUrl:window.accountchooser.images.manWork}, accountWomanHome:{email:"sara_corlett@yahoo.com", displayName:"Sara Corlett", photoUrl:window.accountchooser.images.womanHome}, accountWomanWork:{email:"corlett@alertblue.com", displayName:"Mrs. Corlett", photoUrl:window.accountchooser.images.womanWork}}, footerContainer:{copyright:"Hak cipta 2012 OpenID Foundation.", learnMore:"Tentang Pemilih Akun", learnMoreLink:"/learnmore.html"}});
