...
var MSG_CONTAINER_ABOUT_DEPLOY_BUTTON = function(beginLink, endLink) {
  return beginLink + ("Erfahren Sie mehr \u00fcber die Verwendung der Kontoauswahl." + endLink)
};
...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"Konto hinzuf\u00fcgen", titleMultiple:"Konten hinzuf\u00fcgen", confirm:"Dieses Konto merken", confirmMultiple:"Diese Konten merken", cancel:"\u00dcberspringen"}, updateAccountPage:{title:"Konto aktualisieren", confirm:"Konto aktualisieren", cancel:"Abbrechen"}, selectAccountPage:{title:"Anmelden", seeMoreAccounts:"Mehr", notUsable:"Nicht mit dieser Website verwendbar", addAccount:"Konto hinzuf\u00fcgen"}, 
manageAccountPage:{title:"Konten verwalten", deleteReminder:"Das Konto wurde entfernt. Sie sind aber auf einigen Websites m\u00f6glicherweise immer noch in diesem Konto angemeldet, oder auf diesen Websites ist noch gespeichert, dass Sie dieses Konto verwendet haben."}, manageContainer:{header:"Ihre Konten", description:"Klicken Sie auf ein Konto, um es aus der Kontoauswahl zu l\u00f6schen."}, selectContainer:{header:"Konto f\u00fcr die Anmeldung ausw\u00e4hlen"}, storeContainer:{header:"Konto zu diesem Ger\u00e4t hinzuf\u00fcgen", 
headerMultiple:"Konten zu diesem Ger\u00e4t hinzuf\u00fcgen", description:"St\u00f6rt es Sie, sich so oft anmelden zu m\u00fcssen? Dann f\u00fcgen Sie hier Ihr Konto hinzu. Bei neuen Apps wie etwa bestimmten Einkaufswebsites reicht es zur Anmeldung h\u00e4ufig sogar aus, nur auf das Konto zu klicken oder das Passwort einzugeben.", descriptionMultiple:"St\u00f6rt es Sie, sich so oft anmelden zu m\u00fcssen? Dann f\u00fcgen Sie hier Ihre Konten hinzu. Bei neuen Apps wie etwa bestimmten Einkaufswebsites reicht es zur Anmeldung h\u00e4ufig sogar aus, nur auf das Konto zu klicken oder das Passwort einzugeben.", 
benefits:["Sobald Sie ein Konto zu diesem Ger\u00e4t hinzuf\u00fcgen, brauchen Sie Ihre E-Mail-Adresse nicht mehr jedes Mal einzugeben, wenn Sie von einer Seite zur Anmeldung aufgefordert werden. W\u00e4hlen Sie stattdessen einfach das richtige Konto aus einer Liste aus.", "Einige Seiten werden nach Ihrem Passwort fragen, auf anderen werden Sie automatisch angemeldet, wenn Sie auf den Kontonamen klicken."]}, updateContainer:{header:"Kontodetails aktualisieren", description:"Best\u00e4tigen Sie die Details, die in der Kontoauswahl angezeigt werden."}, 
aboutContainer:{title:"\u00dcber die Kontoauswahl", header:"\u00dcber die Kontoauswahl", sec1Par1:"F\u00fcr mehr Sicherheit und Nutzerfreundlichkeit werden auf Websites herk\u00f6mmliche Anmeldefelder durch eine Kontoauswahl ersetzt. Wenn Sie sich auf einer Website mit Kontoauswahl anmelden m\u00f6chten, wird eine Seite wie diese mit einer Liste der Konten angezeigt, die auf diesem Computer am h\u00e4ufigsten verwendet werden.", subHeader1:"Nutzer: So funktioniert's", sec2Par1:"Sobald Sie ein Konto zu diesem Ger\u00e4t hinzuf\u00fcgen, brauchen Sie Ihre E-Mail-Adresse nicht mehr jedes Mal einzugeben, wenn Sie von einer Seite zur Anmeldung aufgefordert werden. W\u00e4hlen Sie stattdessen einfach das richtige Konto aus einer Liste aus.", 
sec2Par2:"Einige Seiten werden nach Ihrem Passwort fragen, auf anderen werden Sie automatisch angemeldet, wenn Sie auf den Kontonamen klicken.", subHeader2:"Website-Inhaber: Informationen zur Aktualisierung Ihrer Website", sec3Par1:"Die Aktualisierung Ihrer Website zwecks Verwendung einer Kontoauswahl hat einige Vorteile:", sec3Par1List1:"H\u00f6here Anmelde- und Registrierungsraten auf Ihrer Website", sec3Par1List2:"Einfachere Unterst\u00fctzung von Identit\u00e4tsanbietern", sec3Par1List3:"Nur wenige ganz kleine \u00c4nderungen an Ihrer Website erforderlich", 
...
displayName:"Mrs. Corlett", photoUrl:window.accountchooser.images.womanWork}}, footerContainer:{copyright:"Copyright 2012 OpenID Foundation", learnMore:"\u00dcber die Kontoauswahl", learnMoreLink:"/learnmore.html"}});
