...
/**
 * @fileoverview Defines the JSON objects parser of CDS iframe.
 * @author mengcheng@google.com (Mengcheng Duan)
 */
...
window.accountchooser.rpc.checkCdsEmpty_ = function(
    opt_clientConfig) {
  var accounts = window.accountchooser.rpc.
      getAllAccountsByClientConfig_(opt_clientConfig);
