...
var MSG_CONTAINER_ABOUT_DEPLOY_BUTTON = function(beginLink, endLink) {
  return beginLink + ("Saiba como implantar um seletor de conta" + endLink)
};
...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"Adicionar conta", titleMultiple:"Adicionar contas", confirm:"Lembrar esta conta", confirmMultiple:"Lembrar estas contas", cancel:"Ignorar isto"}, updateAccountPage:{title:"Atualizar conta", confirm:"Atualizar conta", cancel:"Cancelar"}, selectAccountPage:{title:"Fazer login em", seeMoreAccounts:"Veja mais", notUsable:"N\u00e3o utiliz\u00e1vel com este site", addAccount:"Adicionar conta"}, manageAccountPage:{title:"Gerenciar contas", 
deleteReminder:"Conta removida. Voc\u00ea ainda pode estar conectado a esta conta em alguns sites, ou esses sites ainda podem lembrar que voc\u00ea usou esta conta."}, manageContainer:{header:"Suas contas", description:"Clique em qualquer conta para exclui-la do Seletor de conta"}, selectContainer:{header:"Selecionar uma conta para fazer login"}, storeContainer:{header:"Adicionar sua conta a este dispositivo", headerMultiple:"Adicionar suas contas a este dispositivo", description:"Cansado de fazer login toda hora? Adicione sua conta aqui. Em alguns aplicativos mais novos (por exemplo, sites de compras), voc\u00ea s\u00f3 precisa clicar na conta ou digitar a senha para fazer login.", 
descriptionMultiple:"Cansado de fazer login toda hora? Adicione suas contas aqui. Em alguns aplicativos mais novos (por exemplo, sites de compras), voc\u00ea s\u00f3 precisa clicar na conta ou digitar a senha para fazer login.", benefits:["Depois de adicionar uma conta a este dispositivo, voc\u00ea n\u00e3o ter\u00e1 que digitar seu endere\u00e7o de e-mail toda vez que uma p\u00e1gina pedir para voc\u00ea fazer login. Basta selecionar a conta desejada na lista.", "Em algumas p\u00e1ginas, ser\u00e1 solicitada a senha, mas em outras, o login acontecer\u00e1 automaticamente ao clicar no nome da conta."]}, 
updateContainer:{header:"Atualizar dados de sua conta", description:"Confirme os dados a serem exibidos no Seletor de conta."}, aboutContainer:{title:"Sobre o Seletor de conta", header:"Sobre o Seletor de conta", sec1Par1:"Os websites est\u00e3o substituindo as tradicionais caixas de login por um seletor de conta para tornar os sites mais seguros e mais f\u00e1ceis de usar. Quando voc\u00ea tenta fazer login nesses sites, aparece uma p\u00e1gina como esta com a lista de contas que voc\u00ea usa com mais frequ\u00eancia no computador.", 
subHeader1:"Usu\u00e1rios: Como funciona", sec2Par1:"Depois de adicionar uma conta a este dispositivo, voc\u00ea n\u00e3o ter\u00e1 que digitar seu endere\u00e7o de e-mail toda vez que uma p\u00e1gina pedir para voc\u00ea fazer login. Basta selecionar a conta desejada na lista.", sec2Par2:"Em algumas p\u00e1ginas, ser\u00e1 solicitada a senha, mas em outras, o login acontecer\u00e1 automaticamente ao clicar no nome da conta.", subHeader2:"Propriet\u00e1rios de sites: Saiba como modernizar seu site", 
sec3Par1:"H\u00e1 v\u00e1rias vantagens em modernizar seu site usando o Seletor de conta:", sec3Par1List1:"Aumentar a quantidade de logins e inscri\u00e7\u00f5es no site", sec3Par1List2:"No futuro, ser\u00e1 mais f\u00e1cil oferecer suporte a provedores de identidade em seu site", sec3Par1List3:"Bastam apenas algumas pequenas mudan\u00e7as em seu site", deployButton:MSG_CONTAINER_ABOUT_DEPLOY_BUTTON('<a href="http://accountchooser.net/owners">', "</a>"), accountManHome:{email:"john.garcia@gmail.com", 
...
learnMore:"Sobre o Seletor de conta", learnMoreLink:"/learnmore.html"}});
