...
var MSG_CONTAINER_ABOUT_DEPLOY_BUTTON = function(beginLink, endLink) {
  return beginLink + ("Informatie over het implementeren van een accountkiezer" + endLink)
};
...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"Account toevoegen", titleMultiple:"Accounts toevoegen", confirm:"Dit account onthouden", confirmMultiple:"Deze accounts onthouden", cancel:"Dit overslaan"}, updateAccountPage:{title:"Account bijwerken", confirm:"Account bijwerken", cancel:"Annuleren"}, selectAccountPage:{title:"Meld u aan om", seeMoreAccounts:"Meer weergeven", notUsable:"Niet te gebruiken met deze site", addAccount:"Account toevoegen"}, 
manageAccountPage:{title:"Accounts beheren", deleteReminder:"Account verwijderd. U bent op bepaalde websites mogelijk nog steeds aangemeld bij dit account of die sites onthouden nog steeds dat u dit account heeft gebruikt."}, manageContainer:{header:"Uw accounts", description:"Klik op een account om het te verwijderen uit de accountkiezer"}, selectContainer:{header:"Selecteer een account waarbij u zich wilt aanmelden"}, storeContainer:{header:"Uw account toevoegen aan dit apparaat", headerMultiple:"Uw accounts toevoegen aan dit apparaat", 
description:"Vindt u het vervelend om u steeds aan en af te melden? Voeg uw account hier toe. Het is mogelijk dat u zich in nieuwe apps (zoals de website van een winkel) al kunt registreren door op het account te klikken of door het wachtwoord van het account op te geven.", descriptionMultiple:"Vindt u het vervelend om u steeds aan en af te melden? Voeg uw accounts hier toe. Het is mogelijk dat u zich in nieuwe apps (zoals de website van een winkel) al kunt registreren door op het account te klikken of door het wachtwoord van het account op te geven.", 
benefits:["Zodra u een account aan dit apparaat heeft toegevoegd, hoeft u uw e-mailadres niet meer te typen wanneer een pagina u vraagt u aan te melden. U kunt eenvoudig het gewenste account selecteren in een lijst.", "Sommige pagina's kunnen vragen om uw wachtwoord, maar op andere pagina's wordt u automatisch aangemeld nadat u op de naam van een account heeft geklikt."]}, updateContainer:{header:"Uw accountgegevens bijwerken", description:"Bevestig de gegevens die in uw accountkiezer worden weergegeven."}, 
aboutContainer:{title:"Over de accountkiezer", header:"Over de accountkiezer", sec1Par1:"Websites vervangen steeds vaker traditionele aanmeldvakken door een accountkiezer waarmee deze sites veiliger en gebruiksvriendelijker worden. Wanneer u probeert u aan te melden op een dergelijke site, krijgt u een pagina te zien zoals deze, met een lijst accounts die u het meest op deze computer gebruikt.", subHeader1:"Gebruikers: hoe het werkt", sec2Par1:"Zodra u een account aan dit apparaat heeft toegevoegd, hoeft u uw e-mailadres niet meer te typen wanneer een pagina u vraagt u aan te melden. U kunt eenvoudig het gewenste account selecteren in een lijst.", 
sec2Par2:"Sommige pagina's kunnen vragen om uw wachtwoord, maar op andere pagina's wordt u automatisch aangemeld nadat u op de naam van een account heeft geklikt.", subHeader2:"Website-eigenaren: leer uw site upgraden", sec3Par1:"Als u ervoor kiest uw site te upgraden naar het gebruik van een accountkiezer, heeft dit verschillende voordelen:", sec3Par1List1:"Meer aanmeldingen en registraties op uw site", sec3Par1List2:"Maakt het gemakkelijker voor uw site om in de toekomst identiteitsproviders te ondersteunen", 
sec3Par1List3:"Het vereist slechts een paar zeer kleine wijzigingen aan uw site", deployButton:MSG_CONTAINER_ABOUT_DEPLOY_BUTTON('<a href="http://accountchooser.net/owners">', "</a>"), accountManHome:{email:"john.garcia@gmail.com", displayName:"John Garcia", photoUrl:window.accountchooser.images.manHome}, accountManWork:{email:"jgarcia@summitmedgroup.com", displayName:"John Garcia", photoUrl:window.accountchooser.images.manWork}, accountWomanHome:{email:"sara_corlett@yahoo.com", displayName:"Sara Corlett", 
photoUrl:window.accountchooser.images.womanHome}, accountWomanWork:{email:"corlett@alertblue.com", displayName:"Mrs. Corlett", photoUrl:window.accountchooser.images.womanWork}}, footerContainer:{copyright:"Copyright 2012 OpenID Foundation.", learnMore:"Over de accountkiezer", learnMoreLink:"/learnmore.html"}});
