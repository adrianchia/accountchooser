...
var MSG_CONTAINER_ABOUT_DEPLOY_BUTTON = function(beginLink, endLink) {
  return beginLink + ("D\u00e9couvrir comment d\u00e9ployer un s\u00e9lecteur de compte" + endLink)
};
...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"Ajouter un compte", titleMultiple:"Ajouter des comptes", confirm:"M\u00e9moriser ce compte", confirmMultiple:"M\u00e9moriser ces comptes", cancel:"Ignorer"}, updateAccountPage:{title:"Mettre \u00e0 jour le compte", confirm:"Mettre \u00e0 jour le compte", cancel:"Annuler"}, selectAccountPage:{title:"Se connecter \u00e0", seeMoreAccounts:"Plus d'informations", notUsable:"Inutilisable avec ce site", 
addAccount:"Ajouter un compte"}, manageAccountPage:{title:"G\u00e9rer les comptes", deleteReminder:"Compte supprim\u00e9. Il est possible que vous soyez toujours connect\u00e9 \u00e0 ce compte sur certains sites Web ou que ceux-ci aient m\u00e9moris\u00e9 que vous avez utilis\u00e9 ce compte."}, manageContainer:{header:"Vos comptes", description:"Cliquez sur un compte pour le supprimer du s\u00e9lecteur de comptes."}, selectContainer:{header:"S\u00e9lectionner un compte pour vous connecter \u00e0"}, 
storeContainer:{header:"Ajouter votre compte \u00e0 cet appareil", headerMultiple:"Ajouter des comptes \u00e0 cet appareil", description:"Vous en avez assez de devoir vous connecter aussi souvent\u00a0? Ajoutez votre compte ici. De nouvelles applications (telles qu'un site commercial) peuvent m\u00eame vous permettre de vous inscrire en cliquant simplement sur le compte ou en saisissant le mot de passe associ\u00e9.", descriptionMultiple:"Vous en avez assez de devoir vous connecter aussi souvent\u00a0? Ajoutez vos comptes ici. De nouvelles applications (telles qu'un site commercial) peuvent m\u00eame vous permettre de vous inscrire en cliquant simplement sur le compte ou en saisissant le mot de passe associ\u00e9.", 
benefits:["Une fois votre compte ajout\u00e9 \u00e0 cet appareil, vous n'aurez plus \u00e0 saisir votre adresse e-mail chaque fois que vous \u00eates invit\u00e9 \u00e0 vous connecter sur une page. Il vous suffit de s\u00e9lectionner le bon compte dans une liste.", "Sur certaines pages, vous serez invit\u00e9 \u00e0 saisir votre mot de passe. Sur d'autres, vous serez connect\u00e9 automatiquement en cliquant sur le nom du compte."]}, updateContainer:{header:"Mettre \u00e0 jour les informations de votre compte", 
description:"Confirmez le d\u00e9tail des informations qui seront affich\u00e9es dans votre s\u00e9lecteur de compte."}, aboutContainer:{title:"\u00c0 propos du s\u00e9lecteur de compte", header:"\u00c0 propos du s\u00e9lecteur de compte", sec1Par1:"Les zones de connexion classiques sont remplac\u00e9es par un s\u00e9lecteur de compte sur les sites Web afin de les rendre plus s\u00e9curis\u00e9s et plus faciles \u00e0 utiliser. Lorsque vous tentez de vous connecter \u00e0 un tel site, une page similaire \u00e0 celle-ci s'affiche et pr\u00e9sente la liste des comptes que vous utilisez le plus fr\u00e9quemment sur cet ordinateur\u00a0:", 
subHeader1:"Utilisateurs\u00a0: fonctionnement", sec2Par1:"Une fois votre compte ajout\u00e9 \u00e0 cet appareil, vous n'aurez plus \u00e0 saisir votre adresse e-mail chaque fois que vous \u00eates invit\u00e9 \u00e0 vous connecter sur une page. Il vous suffit de s\u00e9lectionner le bon compte dans une liste.", sec2Par2:"Sur certaines pages, vous serez invit\u00e9 \u00e0 saisir votre mot de passe. Sur d'autres, vous serez connect\u00e9 automatiquement en cliquant sur le nom du compte.", subHeader2:"Propri\u00e9taires de sites Web\u00a0: d\u00e9couvrez comment mettre \u00e0 jour votre site", 
sec3Par1:"La mise \u00e0 jour de votre site afin d'utiliser un s\u00e9lecteur de compte pr\u00e9sente plusieurs avantages\u00a0:", sec3Par1List1:"augmentation des taux de connexion et d'inscription relev\u00e9s sur votre site\u00a0;", sec3Par1List2:"meilleure compatibilit\u00e9 de votre site avec les fournisseurs d'identit\u00e9 \u00e0 l'avenir\u00a0;", sec3Par1List3:"quelques modifications mineures requises seulement.", deployButton:MSG_CONTAINER_ABOUT_DEPLOY_BUTTON('<a href="http://accountchooser.net/owners">', 
...
footerContainer:{copyright:"Copyright OpenID Foundation 2012", learnMore:"\u00c0 propos du s\u00e9lecteur de compte", learnMoreLink:"/learnmore.html"}});
