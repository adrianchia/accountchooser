...
var MSG_CONTAINER_ABOUT_DEPLOY_BUTTON = function(beginLink, endLink) {
  return beginLink + ("M\u00e9s informaci\u00f3 sobre com implementar un selector de comptes" + endLink)
};
...
window.accountchooser.labels = jQuery.extend(window.accountchooser.labels || {}, {shareAccountPage:{title:"Addici\u00f3 d'un compte", titleMultiple:"Addici\u00f3 de comptes", confirm:"Recorda aquest compte", confirmMultiple:"Recorda aquests comptes", cancel:"Omet aquest pas"}, updateAccountPage:{title:"Actualitzaci\u00f3 del compte", confirm:"Actualitza el compte", cancel:"Cancel\u00b7la"}, selectAccountPage:{title:"Inici de la sessi\u00f3 a", seeMoreAccounts:"Mostra'n m\u00e9s", notUsable:"No es pot utilitzar amb aquest lloc", 
addAccount:"Afegeix un compte"}, manageAccountPage:{title:"Gesti\u00f3 de comptes", deleteReminder:"S'ha eliminat el compte. En alguns llocs web encara podeu iniciar la sessi\u00f3 en aquest compte, o aquests llocs encara poden recordar que vau utilitzar aquest compte."}, manageContainer:{header:"Els vostres comptes", description:"Feu clic en qualsevol compte per suprimir-lo del Selector de comptes"}, selectContainer:{header:"Selecci\u00f3 d'un compte per iniciar la sessi\u00f3 a"}, storeContainer:{header:"Addici\u00f3 del compte a aquest dispositiu", 
headerMultiple:"Addici\u00f3 de comptes en aquest dispositiu", description:"Si esteu cansat d'haver d'iniciar la sessi\u00f3 tan sovint, afegiu el vostre compte aqu\u00ed. \u00c9s possible que les aplicacions noves (com ara un lloc web de compres) us permetin registrar-vos fent clic al compte o escrivint-ne la contrasenya.", descriptionMultiple:"Si esteu cansat d'haver d'iniciar la sessi\u00f3 tan sovint, afegiu el vostre compte aqu\u00ed. \u00c9s possible que les aplicacions noves (com ara un lloc web de compres) us permetin registrar-vos fent clic al compte o escrivint-ne la contrasenya.", 
benefits:["Quan afegiu un compte al dispositiu, no us caldr\u00e0 escriure l'adre\u00e7a electr\u00f2nica cada vegada que una p\u00e0gina us demani que inicieu la sessi\u00f3. Nom\u00e9s cal que seleccioneu el compte correcte d'una llista.", "Hi ha p\u00e0gines que us demanaran una contrasenya, per\u00f2 d'altres us iniciaran la sessi\u00f3 autom\u00e0ticament quan feu clic al nom del compte."]}, updateContainer:{header:"Actualitzaci\u00f3 de la informaci\u00f3 del compte", description:"Confirmeu la informaci\u00f3 que apareixer\u00e0 al Selector de comptes."}, 
aboutContainer:{title:"Quant al Selector de comptes", header:"Quant al Selector de comptes", sec1Par1:"Els llocs web estan substituint els quadres d'inici de sessi\u00f3 tradicionals per un selector de comptes, amb l'objectiu que aquests llocs siguin m\u00e9s segurs i m\u00e9s f\u00e0cils de fer servir. Quan proveu d'iniciar la sessi\u00f3 a un lloc d'aquest tipus, veureu una p\u00e0gina com aquesta, amb la llista de comptes que feu servir a l'equip m\u00e9s freq\u00fcentment.", subHeader1:"Usuaris: funcionament", 
sec2Par1:"Quan afegiu un compte al dispositiu, no us caldr\u00e0 escriure l'adre\u00e7a electr\u00f2nica cada vegada que una p\u00e0gina us demani que inicieu la sessi\u00f3. Nom\u00e9s cal que seleccioneu el compte correcte d'una llista.", sec2Par2:"Hi ha p\u00e0gines que us demanaran una contrasenya, per\u00f2 d'altres us iniciaran la sessi\u00f3 autom\u00e0ticament quan feu clic al nom del compte.", subHeader2:"Propietaris de llocs web: m\u00e9s informaci\u00f3 sobre com actualitzar el vostre lloc", 
sec3Par1:"Hi ha diversos avantatges d'actualitzar el vostre lloc perqu\u00e8 faci servir un Selector de comptes:", sec3Par1List1:"Feu augmentar els percentatges d'inici de sessi\u00f3 i d'inscripci\u00f3 al vostre lloc", sec3Par1List2:"Fa que sigui m\u00e9s f\u00e0cil que el vostre lloc sigui compatible amb els prove\u00efdors d'identitat en el futur", sec3Par1List3:"Nom\u00e9s cal que feu uns petits canvis al lloc", deployButton:MSG_CONTAINER_ABOUT_DEPLOY_BUTTON('<a href="http://accountchooser.net/owners">', 
...
footerContainer:{copyright:"Copyright 2012 OpenID Foundation.", learnMore:"Quant al Selector de comptes", learnMoreLink:"/learnmore.html"}});
